  ...
  if (staggerContainers.length > 0 && 'IntersectionObserver' in window) {
    const staggerObserver = new IntersectionObserver(function (entries) {
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          ...
          const staggerDelay = parseInt(container.getAttribute('data-stagger'), 10) || 100;
          const children = container.children;

          Array.prototype.forEach.call(children, function (child, index) {
            setTimeout(function () {
              child.classList.add('scroll-animate-visible');
              child.classList.remove('scroll-animate-ready');
            }, index * staggerDelay);
          });
    ...
    staggerContainers.forEach(function (container) {
      Array.prototype.forEach.call(container.children, function (child) {
        child.classList.add('scroll-animate-ready');
      });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7b0c6bdb-955f-461d-99f5-cb52f44870f9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7b0c6bdb-955f-461d-99f5-cb52f44870f9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7b0c6bdb-955f-461d-99f5-cb52f44870f9';
